...
REF.:/watch?v=E_XZHQkQBBU&list=PLHae9ggVvqPgyRQQOtENr6hK0m1UquGaG&index=25
@author: bragatte
"""
...
io.imsave("Crosstope/data/images/saved_using_skimage.jpg", gaussian_img)
...
import cv2
cv2.imwrite("Crosstope/data/images/saved_using_opencv.jpg", gaussian_img)
