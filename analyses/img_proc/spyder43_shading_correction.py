# -*- coding: utf-8 -*-
"""
Created on Tue May 18 23:32:38 2021
REF.:watch?v=BQ-YrAIl2GU&list=PLHae9ggVvqPgyRQQOtENr6hK0m1UquGaG&index=45
@author: Bragatte
...
img = cv2.imread("/home/bragatte/Documentos/GitHub/Crosstope/data/images/grasp/zikv/ALPVYLMTL_5K.jpg", 1)
...
cv2.imshow("/home/bragatte/Documentos/GitHub/Crosstope/data/images/grasp/zikv/ALPVYLMTL_5K.jpg", img)
cv2.imshow("/home/bragatte/Documentos/GitHub/Crosstope/data/images/grasp/zikv/ALPVYLMTL_5K.jpg", corrected_image)
cv2.waitKey(0)
...
img = cv2.imread("/home/bragatte/Documentos/GitHub/Crosstope/data/images/grasp/zikv/ALPVYLMTL_5K.jpg", 0)
