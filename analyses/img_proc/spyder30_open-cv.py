...
import cv2 
#img = cv2.imread("data\images\grasp\zikv\ALPVYLMTL_5K.jpg", 1) #win
img = cv2.imread("data/images/grasp/zikv/ALPVYLMTL_5K.jpg", 1) #linux
...
grey_img = cv2.imread("data/images/grasp/zikv/ALPVYLMTL_5K.jpg", 0) 
img = cv2.imread("data/images/grasp/zikv/ALPVYLMTL_5K.jpg", 1)   #Color is BGR not RGB
...
img = cv2.imread("data/images/grasp/zikv/ALPVYLMTL_5K.jpg", 0)
