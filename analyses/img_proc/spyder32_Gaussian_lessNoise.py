...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr 11 19:47:07 2021
[REF](watch?v=MTaCVDll9Iw&list=PLHae9ggVvqPgyRQQOtENr6hK0m1UquGaG&index=34)actor by
@author: bragatte
...
img_gaussian_noise = img_as_float(io.imread('/data/images/grasp/zikv/ALPVYLMTL_5K_noise.png', as_gray=True))
img_salt_pepper_noise = img_as_float(io.imread('/data/images/grasp/zikv/ALPVYLMTL_5K_noise.png', as_gray=True))
