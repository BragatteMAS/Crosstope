...
img_gaussian_noise = cv2.imread('/data/images/grasp/zikv/ALPVYLMTL_5K_noise.png', 0)
img_salt_pepper_noise = cv2.imread('/data/images/grasp/zikv/ALPVYLMTL_5K_noise.png', 0)
